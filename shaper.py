...
parser.add_argument('-i', '--input-path', default='data/coco/coco_glove_word2vec.pkl',
                    type=str, help='Input Path')
parser.add_argument('-a', '--adj-path', default='data/coco/coco_adj.pkl',
                    type=str, help='Adjacency Path')
parser.add_argument('-o', '--output-path', default='data/coco/coco_glove_word2vec_eig.pkl',
                    type=str, help='Output Path')
parser.add_argument('-n', '--normalise', action='store_true', help='perform normalisation')
parser.add_argument('-ec', '--eigenc', action='store_true', help='perform EC normalisation')
...
def main():
    ...
    if args.eigenc:
        print('Eigenvector Centrality Normalisation')
